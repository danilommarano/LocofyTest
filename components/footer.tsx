...
const Footer: NextPage = () => {
  return (
    <footer className="self-stretch [background:linear-gradient(91.74deg,_#0b5ba8_25.38%,_#299bd8)] flex flex-row py-[24.668806076049805px] px-[62.7933235168457px] items-start justify-start gap-[32.89px] text-left text-[13.46px] text-primary-contrast font-roboto lg:p-10 lg:box-border md:flex-col md:pt-10 md:px-6 md:pb-[30px] md:box-border sm:py-[30px] sm:px-6 sm:box-border">
