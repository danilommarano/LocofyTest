...
const PopularDestinationsContainer: NextPage = () => {
  return (
    <div className="self-stretch flex flex-col items-start justify-start gap-[17.94px] text-left text-[13.46px] text-cornflowerblue-200 font-roboto">
      ...
      <div className="self-stretch flex flex-row items-start justify-start ml-[-16px] mr-[-16px] md:ml-[-16px] md:mr-[-16px] md:flex-wrap md:mt-[-16px] md:mb-[-16px]">
        <TripCard
          ...
          propBackgroundImage={`url("/frame-696@3x.png")`}
          propWidth="67.97px"
          propWidth1="67.97px"
          propLeft="28.7px"
        />
