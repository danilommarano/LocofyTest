...
type HotelCardContainerType = {
  ...
  roomDimensionsComparison?: string;
...
const HotelCardContainer: NextPage<HotelCardContainerType> = ({
  ...
  return (
    <div className="self-stretch flex-1 flex flex-row py-0 px-[8.970474243164062px] box-border items-start justify-center w-3/12 text-left text-[11.96px] text-darkslategray-300 font-roboto md:w-[33.33%] sm:w-full sm:flex-[unset] sm:self-stretch">
      <a
      ...
      >
        ...
        <div className="relative w-[201.84px] h-[14.2px] text-cornflowerblue-100">
        ...
        <button className="cursor-pointer p-0 bg-[transparent] self-stretch rounded-[2.99px] box-border h-[34.39px] overflow-hidden shrink-0 flex flex-col items-center justify-center border-[0.7px] border-solid border-lavender sm:w-[100%!important]">
          <div className="relative text-[11.21px] tracking-[0.34px] leading-[19.44px] uppercase font-medium font-roboto text-cornflowerblue-100 text-left inline-block w-[81.48px] h-[19.44px] shrink-0">
            More details
          </div>
        </button>
      </a>
