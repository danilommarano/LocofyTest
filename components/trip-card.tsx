      ...
      >
        <div className="absolute w-[calc(100%_-_0.44px)] top-[0px] right-[0.22px] left-[0.22px] flex flex-row py-[5.980316638946533px] px-[8.970474243164062px] box-border items-start justify-start">
          ...
          >
            ...
            <div
              className="absolute top-[0px] left-[28.7px] text-[11.96px] tracking-[0.04em] uppercase font-roboto text-primary-contrast text-right inline-block w-[39.27px] h-[14.2px]"
              style={fromStyle}
            >
              from
            </div>
